...
function wmpdownloads_search($queryarray, $andor, $limit, $offset, $userid)
{
    global $xoopsDB;

    $sql = 'SELECT d.lid,d.cid,d.title,d.submitter,d.date,t.description FROM ' . $xoopsDB->prefix('wmpdownloads_downloads') . ' d LEFT JOIN ' . $xoopsDB->prefix('wmpdownloads_text') . ' t ON t.lid=d.lid WHERE status>0';
